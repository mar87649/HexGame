...
namespace Ludiq.Fixes
{
	public class GeneratePropertyProvidersPage : Page
	{
		...
		{
			title = $"Generate Custom Inspectors Fixed";
			shortTitle = "Inspectors";
			icon = LudiqCore.Resources.LoadIcon("Icons/Windows/GeneratePropertyProvidersWindow/GeneratePropertyProvidersPage.png");
		}
		...
		protected override void OnContentGUI()
		{
			...
			if (GUILayout.Button("Generate Inspectors", Styles.nextButton))
			{
				try
				{
					SerializedPropertyProviderProvider.instance.GenerateProviderScriptsFixed();
